...
<div class="topnav">
  ...
  <a href="#" onclick='show(2);'>Update/Delete Manager</a>
   <div class="dropdown">
  <button class="dropbtn">Truck Report 
    </button>
  ...
  <div class="dropdown">
  <button class="dropbtn">Manager Report 
    </button>
    <div class="dropdown-content">
      <a href="#">PDF</a>
      <a href="#">Excel</a>
      ...
      <tbody>
        <tr>
         ...
         <td>John </td>
          ...
          <td><form action="EditManager.jsp"><button onclick="showForm()">Edit</button></form></td>
...
background-image: linear-gradient(315deg, #000000 0%, #414141 74%) ; padding-top: -1000px; padding-top: 50px; border-radius: 30px;"   class="leave-request-form">
  ...
  <div class="form-group row" style="width: 80%;margin-left: 10%;margin-top: 20px;">
    ...
    <div class="col-8">
      <input style="width: 100%; height: 30px" class="form-control" type="text" value="" id="example-text-input" #emp_num>
    </div>
  </div>
  ...
  <div class="form-group row" style="width: 80%;margin-left: 10%;margin-top: 20px;">
    ...
    <div class="col-8">
      <input style="width: 100%;  height: 30px" class="form-control" type="email" value="" id="example-text-input" #emp_num>
    </div>
  </div>
  ...
  <div class="form-group row" style="width: 80%;margin-left: 10%;margin-top: 20px;">
    <label  style="color: white" for="example-text-input" class="col-4 col-form-label">Password<b style="color:red">*</b></label>
    <div class="col-8">
      <input style="width: 100% ;  height: 30px" class="form-control" type="password" value="" id="example-text-input" #emp_num>
    </div>
  </div>
